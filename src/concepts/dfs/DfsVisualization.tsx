...
export function DfsVisualization(props: VisualizationProps) {
  ...
  return (
    <div className="relative w-full h-full">
      ...
      {/* Legend */}
      <div className="absolute bottom-16 left-4 flex items-center gap-3 rounded-lg border border-gray-700/50 bg-gray-950/80 backdrop-blur-sm px-2.5 py-1.5 text-[10px] pointer-events-none">
      ...
      {/* Traversal order bar */}
      <div className="absolute bottom-4 left-1/2 -translate-x-1/2 flex items-center gap-1.5 flex-wrap rounded-xl border border-gray-700/50 bg-gray-950/90 backdrop-blur-sm px-4 py-2 shadow-xl pointer-events-none min-h-[36px]">
